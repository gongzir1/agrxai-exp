...
train_imgs = train_imgs[0:60000, :]        # torch.Size([6000, 784])
# print('train_imgs.shape')
# print(train_imgs.shape)

test_imgs = torch.tensor(test_imgs, dtype=torch.float)
test_imgs = test_imgs[0:10000, :]          # torch.Size([1000, 784])
# print('test_imgs.shape')
# print(test_imgs.shape)

train_labels = torch.tensor(train_labels, dtype=torch.long)
# train_labels = train_labels[0:60000, :]            # torch.Size([6000, 1])
# print('train_labels.shape')
# print(train_labels.shape)

test_labels = torch.tensor(test_labels, dtype=torch.long)
test_labels = test_labels[0:10000, :]              # torch.Size([1000, 1])
...
for att_mode in constants.all_the_attack:
    ...
    for exp in [
        ...
        cgd.federated_init()
        cgd.grad_reset()
        cgd.data_distribution(validation_size=2000, agr_clean_size=1000)     # 设置validation set的切出来，这里从10000个test中拿了2000个
